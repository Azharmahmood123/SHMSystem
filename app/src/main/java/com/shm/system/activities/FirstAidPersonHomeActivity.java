...
public class FirstAidPersonHomeActivity extends AppCompatActivity implements View.OnClickListener, PatientsTreatedAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_aid_person_home);
        findView();
        initializeControls();
        attachListeners();
    }
    ...
    private void initializeControls() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(FirstAidPersonHomeActivity.this));
        patientsTreatedAdapter = new PatientsTreatedAdapter(treatmentObjectList, FirstAidPersonHomeActivity.this);
        ...
        loadFirstAidTreatedPatientsData();
    }
    ...
    public void onClick(View v) {
        if (v == tvLogout) {
            Dialogs.showAlertWithTwoButton(FirstAidPersonHomeActivity.this, "Are you sure, you want to logout?", "Logout",
                    "Logout", "Cancel", new Dialogs.OnDialogButtonClickListener() {
                        ...
                        public void onDialogPositiveButtonClick() {
                            ...
                            Intent intent = new Intent(FirstAidPersonHomeActivity.this, SignInActivity.class);
                            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                            startActivity(intent);
                            FirstAidPersonHomeActivity.this.finish();
                        }
            ...
            AddPatientDialog addPatientDialog = new AddPatientDialog(FirstAidPersonHomeActivity.this, new AddPatientDialog.OnDialogButtonClickListener() {
                @Override
    ...
    public void onItemClick(View view, int position) {
        ...
        Intent intent = new Intent(FirstAidPersonHomeActivity.this, PatientTreatmentDetailActivity.class);
        startActivity(intent);
    }
    ...
    private void createDialogMethod() {
        pDialog = new ProgressDialog(FirstAidPersonHomeActivity.this);
    ...
    private void loadFirstAidTreatedPatientsData() {
        if (NetworkUtil.isNetworkAvailable(FirstAidPersonHomeActivity.this)) {
            createDialogMethod();
            ...
            Query query = databaseReference.orderByChild("firstAidPersonUserID").equalTo(userID);
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        if (treatmentObjects.size() > 0) {
                            ...
                            Intent intent = new Intent(FirstAidPersonHomeActivity.this, PatientTreatmentHistoryActivity.class);
                            startActivity(intent);
                        } else {
    ...
    private void showNoHistoryFoundDialog(){
        Dialogs.showAlertWithTwoButton(FirstAidPersonHomeActivity.this,
                ...
                new Dialogs.OnDialogButtonClickListener() {
                    ...
                    public void onDialogPositiveButtonClick() {
                        GetterSetter.setUserObject(patientObject);
                        Intent intent = new Intent(FirstAidPersonHomeActivity.this, AddPatientTreatmentActivity.class);
                        startActivity(intent);
                    }
